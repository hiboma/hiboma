...
+ 1bytes EVENT_TYPE_OFFSET             event type
+ 4bytes SERVER_ID_OFFSET              server_id
+ 4bytes EVENT_LEN_OFFSET              data_written ( header+ event_length )
+ 4bytes LOG_POS_OFFSET                log_pos
+ 2bytes FLAGS_OFFSET                  flags
------------------------------------------------------------>
...
? 1+1      Q_CATALOG_NZ_CODE           catalog_len
?                                      catalog
? 1+2bytes Q_AUTO_INCREMENT            auto_increment_increment
?   2bytes ...                         auto_increment_offset
? 1+6bytes Q_CHARSET_CODE              charset
? 1+1bytes Q_TIME_ZONE_CODE            time_zone_str
           ...                         time_zone_len
