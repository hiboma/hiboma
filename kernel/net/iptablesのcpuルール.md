 ...
 * smp_processor_id() でパケットを処理をしている CPU 番号を取って、--cpu とマッチするかどnうか
 * CPUごとにマッチするルールによって、パケットを複数ポートで LISTEN しているデーモンに分散させるってなことが出来る
   * td-agent みたいなマルチプロセス + 複数ポートのやつとかに有効?
