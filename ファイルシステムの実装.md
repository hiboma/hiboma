 ...
 * RAMベースの場合は、ファイルシステムの都合で適当に初期化しておけば良い
   * [tmpfsの例](http://lxr.free-electrons.com/source/mm/shmem.c?v=2.6.32#L1541)を見るのがよい 
...
## struct super_operations の実装 [#](http://lxr.free-electrons.com/source/include/linux/fs.h?v=2.6.32#L1562) 
